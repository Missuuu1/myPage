! function (t) {
    ...
    var _ = {
            data: () => ({
                ...
                aboutMe: [{
                    title: "我是王彬",
                    content: "来自山东烟台的我，于2019年入读沈阳理工大学，就读计算机科学与技术专业。开始自学前端，完成自己的首个项目--我的个人主页2019版本。自此方向确定为前端开发以及全栈开发。",
        ...
        T = {
            ...
            data: () => ({
                serviceContent: [{
                    ...
                    serviceTitle: "网站制作",
                    serviceContent: "根据用户的需求制作符合用户心意的网站,类型包括个人网站，企业网站。用户提供网站设计稿的情况更便宜。"
                }, {
                    serviceIcon: "fa-bed",
                    serviceTitle: "网站托管",
                    serviceContent: "支持托管个人网站,包括域名的注册、空间的租用、服务器系统的管理、信息的上传、主页的创意、网页的制作更新、Email系统的。"
                }, {
                    serviceIcon: "fa-bug",
                    serviceTitle: "软件开发",
                    serviceContent: "根据用户的需求制作符合用户心意的软件、小程序等移动终端"
                }, {
                    serviceIcon: "fa-handshake-o",
                    serviceTitle: "商业合作",
                    serviceContent: "你提idea,我来实现"
                }]
            }),
            methods: {
                getOffsetTop() {
    ...
    var S = {
            ...
            data: () => ({
                experience: [{
                    ...
                    company: "自主开发",
                    doWhat: "使用JavaScript搭建了个人主页2018版本，同时使用webpack作为打包工具。"
                }, {
                    time: "2019.10",
                    color: "rgb(235,84,36)",
                    company: "学习充实",
                    doWhat: "学习ES6语法，熟练使用Vue和Uni-app开发，使用nodejs搭建图片上传接口。在完成项目的过程中，封装了一些可复用插件，例如富文本编辑器，登录模态框，动态魔方背景等。"
                }, {
                    time: "2020.6",
                    color: "rgb(187,30,16)",
                    company: "实战经历",
                    doWhat: "注册域名并购买阿里云服务器，开发多种网站、APP和小程序等，如成功上线的在线音乐馆"
                }, {
                    time: "2021.07",
                    color: "rgb(35,127,82)",
                    company: "竞赛荣誉",
                    doWhat: "截止到2021年7月，已获得全国大学生大数据分析与挖掘竞赛、全国大学生数学建模竞赛等奖项若干及多种奖学金"
                }, {
                    time: "2022",
                    color: "rgb(253,189,16)",
                    company: "未完待续",
                    doWhat: "在前端开发的道路上一步一个脚印，不断积累和充实自己，冷静克服重重困难，期待下一次挑战..."
                }]
            })
        },
    ...
    var F = {
            ...
            data: () => ({
                blogList: [{
                    ...
                    title: "github",
                    color: "#000",
                    content: "2018年开始接触github，每次做项目都会同步到github上。最近开启了插件制作项目，都是在项目完成过程中，可以复用的功能模块，然后封装成插件。",
                    href: "https://github.com/"
                }, {
                    faClass: "fa-book",
                    color: "rgb(234,111,90)",
                    title: "简书",
                    content: "2018年6月开始接触简书，使用简书阅读文章，努力地牢固自己的知识。",
                    href: "https://www.jianshu.com/"
                }, {
                    faClass: "fa-codepen",
                    color: "rgb(0,127,255)",
                    title: "掘金",
                    content: "2018年3月开始接触掘金，丰富和充实自己。",
